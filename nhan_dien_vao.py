...
char_detector = YOLO(r"E:\IOT\project\PY\VehicleScanner\trainVungKyTu\runs\detect\train\weights\best.pt")
plate_detector = YOLO(r"E:\IOT\project\PY\VehicleScanner\runs\detect\train\weights\best.pt")
